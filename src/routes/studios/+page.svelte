<script lang="ts">
	...
	const monitors = ['Genelec 1037B', 'Yamaha NS-10'];
</script>
...
<svelte:head>
	...
	<meta
		name="description"
		content="Kram Studio was designed from the ground up as a no-compromise mastering facility. High-end
	...
	possible allowing us to make the decisions necessary to make your music sound its best."
	/>
</svelte:head>

<section class="container overflow-hidden w-full">
	<h1 class="text-lg md:text-2xl font-bold text-center my-8 uppercase text-yellow-300">Studios</h1>
...
>
	<div class="w-full">
		<h2
			class="text-base lg:text-lg uppercase my-8 font-semibold text-yellow-300"
		...
		<ul>
			{#each hardwares as hardware, idx}
				...
				>
					<span class="font-semibold text-[#71CC00] mr-2 text-xl"> - </span>
					{hardware}
				</li>
			{/each}
		</ul>
